                ...
                <div class="row gx-4">
                    ...
                    <div class="col-lg-6 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                        <div class="nav-wrapper position-relative end-0">
                            <h6 class="mb-0">{{ __('Semester Information') }}</h6>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="@error('code')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="" type="text" placeholder="i.e : S3 24"
                                            id="code" name="code">
                                        @error('code')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="@error('category-name')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="" type="text"
                                            placeholder="i.e : SEMESTER 3 2024/2025" id="name" name="name">
                                        @error('name')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="@error('year')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="" type="text" placeholder="i.e : 2024"
                                            id="year" name="year">
                                        @error('year')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
