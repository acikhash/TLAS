                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control datepicker" placeholder="Please select date" id="dateStart"
                                    name="dateStart" type="date" onfocus="focused(this)" onfocusout="defocused(this)">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="@error('event.veneu') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="i.e : PWTC" id="name"
                                        name="veneu" value="">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('organizer') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text"
                                        placeholder="i.e : Universiti Teknologi Malaysia" id="organizer" name="organizer"
                                        value="">
                                </div>
                            </div>
                        </div>
