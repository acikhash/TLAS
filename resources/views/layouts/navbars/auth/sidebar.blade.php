<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if (Auth::user()->role === App\Models\User::ROLE_PGAM || Auth::user()->role === App\Models\User::ROLE_DIRECTOR)
                ...
                <li class="nav-item mt-2">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Staff Workload</h6>

                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('Workload') ? 'active' : '' }}"
                        href="{{ route('workload.index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
            ...
            @endif
            @if (Auth::user()->role === App\Models\User::ROLE_COORDINATOR)
                <li class="nav-item mt-2">
            ...
            @endif
            @if (Auth::user()->role === App\Models\User::ROLE_PGAM || Auth::user()->role === App\Models\User::ROLE_COORDINATOR)
                <li class="nav-item mt-2">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Assign Course</h6>

                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('Assignment') ? 'active' : '' }}"
            ...
            @endif
            @if (Auth::user()->role === App\Models\User::ROLE_USER||Auth::user()->role === App\Models\User::ROLE_PGAM)
                <li class="nav-item mt-2">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">View Assignment</h6>
            ...
            @endif
            @if (Auth::user()->role === App\Models\User::ROLE_PGAM)
                <li class="nav-item mt-2">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">System Setting</h6>
                ...
                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('Major') ? 'active' : '' }}"
                ...
                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('Title') ? 'active' : '' }}"
