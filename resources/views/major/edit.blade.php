                ...
                <div class="card-body pt-4 p-3">
                    <form method="post" action="{{ route('major.update', $major) }} " enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name" class="form-control-label">{{ __('Major Name') }}</label>
                                    <div class="@error('name')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="{{ old('name', $major->name) }}" type="text"
                                            placeholder="i.e : Pengajaran" id="name" name="name">
                                        @error('name')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="credit" class="form-control-label">{{ __('Min Credit') }}</label>
                                    <div class="@error('credit')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="{{ old('credit', $major->credit) }}"
                                            type="number" placeholder="i.e : 5" id="credit" name="credit">
                                        @error('credit')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
