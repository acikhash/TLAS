                                ...
                                <select name="department_id" class="form-select" id="department_id">
                                    @foreach ($departments as $department)
                                        <option value={{ $department->id }}
                                            @if ($program->department_id == $department->id) Selected @endif>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="@error('code')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="{{ old('code', $program->code) }}" type="text"
                                            placeholder="i.e : MBA " id="code" name="code">
                                        @error('code')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="@error('name')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="{{ old('name', $program->name) }}"
                                            type="text" placeholder="i.e : Master of Business Intelligence"
                                            id="name" name="name">
                                        @error('name')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                ...
                                <select name="staff_id" class="form-select" id="staff_id">
                                    @foreach ($staffs as $staff)
                                        <option value={{ $staff->id }}
                                            @if ($program->staff_id == $staff->id) Selected @endif>
